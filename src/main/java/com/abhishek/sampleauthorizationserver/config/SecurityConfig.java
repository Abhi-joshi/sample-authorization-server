package com.abhishek.sampleauthorizationserver.config;
...
public class SecurityConfig {
    ...
    public SecurityConfig(EndUserService endUserService, @Value("${app.allowed-origins}") List<String> allowedOrigins) {
